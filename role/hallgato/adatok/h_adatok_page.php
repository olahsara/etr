        ...
        <div class="pageContent">
            ...
            <div class="adatok">
                ...
                $atlag = 'SELECT SUM(ADATB."Hallgato_Kurzus"."Erdem_jegy") AS "jegy", COUNT(ADATB."Hallgato_Kurzus"."Erdem_jegy") AS "db"
                          ...
                          AND ADATB."Hallgato".HALLGATO_ID LIKE ' .$_SESSION["felhasznalo"]["id"];
                $params1 = lekerdez($atlag);
                while ($record = oci_fetch_array($params1[0], OCI_ASSOC + OCI_RETURN_NULLS)) {
                    if ($record['db']!=0){
                ...
                $params2 = lekerdez($sulyozott_atlag);

                while ($record = oci_fetch_array($params2[0], OCI_ASSOC + OCI_RETURN_NULLS)) {
