...
$ora_id_select = 'SELECT ADATB."Ora"."ORA_ID"
                  ...
                  AND ADATB."Hallgato".HALLGATO_ID LIKE '.$_POST['hallgato-id'].' AND ADATB."Kurzus".KURZUS_ID LIKE '.$_POST["kurzus_id"];
...
$delete1 = 'DELETE FROM ADATB."Hallgato_Ora"
           ...
           AND ADATB."Hallgato_Ora"."ho_Hallgato_id" LIKE '.$_POST['hallgato-id'];

excecute($delete1);

$delete2 = 'DELETE FROM ADATB."Hallgato_Kurzus" WHERE ADATB."Hallgato_Kurzus"."hk_Kurzus_id" LIKE '.$_POST["kurzus_id"].'
           AND ADATB."Hallgato_Kurzus"."hk_Hallgato_id" LIKE '.$_POST['hallgato-id'];
