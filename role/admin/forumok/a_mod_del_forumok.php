    ...
    <?php if(isset($_SESSION["felhasznalo"]) && $_SESSION["felhasznalo"]["role"] === 'admin' ){
        ...
        if (isset($_GET['value'])) {
            ...
            while ($record = oci_fetch_array($params[0], OCI_ASSOC + OCI_RETURN_NULLS)) {
                ...
                echo sprintf('
                                    <form action="a_forumok_mod.php?value=' . urlencode($record['ID']) . '" method="post">
                                        <tr>
                                            <td>%s</td>
                                            <td>
                                            ...
                                            <td>
                                                <input class="submit" type="submit" value="Update Fórum">
                                                <a href="a_forumok_del.php?value=' . urlencode($record['ID']) . '">Delete Fórum</a>
                                            </td>
                                            </tr>
