    ...
    <?php if(isset($_SESSION["felhasznalo"]) && $_SESSION["felhasznalo"]["role"] === 'admin' ){
        ...
        if (isset($_GET['value'])) {
            ...
            while ($record = oci_fetch_array($params[0], OCI_ASSOC + OCI_RETURN_NULLS)) {
                ...
                echo sprintf('
                                    <form action="a_vizsgak_mod.php?value=' . urlencode($record['ID']) . '" method="post">
                                        <tr>
                                            <td>%s</td>
                                            <td>
                                            ...
                                            <td>
                                                <input class="submit" type="submit" value="Update Vizsga">
                                                <a href="a_vizsgak_del.php?value=' . urlencode($record['ID']) . '">Delete Vizsga</a>
                                            </td>
                                            </tr>
                                    </form>', $record['ID'], $record['VIZSGA_IDOPONT']);
            }
